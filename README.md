...
| `commerce.notification` | Alert configuration and notification delivery destinations | "Show my notification destinations." |
...
| `communication` | Notification subscriptions, topics, filters, and public keys | "Show my notification subscriptions." |
...
| [Commerce Notification](src/ebay/commerce/notification/) | Alert configuration and delivery destinations under `commerce.notification` |
...
| [Communication](src/tools/categories/communication.ts) | Notification subscriptions, topics, filters, and public keys |
