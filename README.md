...
| `developer` / `token-management` | API status, signing keys, OAuth URLs, token refresh, and diagnostics | "Check whether eBay APIs and my token are healthy." |
