...
| --- | --- | --- |
| `account` | Deprecated payments-program status and sales tax | "Show my eBay sales-tax settings." |
| `sell.account` | Seller status, program enrollment, subscriptions, rate tables, advertising eligibility, and business policies | "Show my opted-in eBay seller programs." |
...
| [Account](src/tools/categories/account.ts) | Deprecated payments-program status; sales tax |
| [Sell Account](src/ebay/sell/account/) | Seller status, program enrollment, subscriptions, rate tables, advertising eligibility, and business policies under `sell.account` |
