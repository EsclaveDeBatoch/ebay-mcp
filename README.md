...
| --- | --- | --- |
| `account` | Return policies, sales tax, subscriptions, and programs | "Show my eBay return policies." |
| `sell.account` | Payment, fulfillment, product-compliance, and take-back policies | "Show my eBay payment policies." |
...
| [Account](src/tools/categories/account.ts) | Return policies; programs; subscriptions; sales tax |
| [Sell Account](src/ebay/sell/account/) | Seller payment, fulfillment, product-compliance, and take-back policies under `sell.account` |
