...
| `commerce.notification` | Application-level notification alert configuration | "Show my notification alert email." |
...
| `communication` | Notification destinations, subscriptions, topics, filters, and public keys | "Show my notification subscriptions." |
...
| [Commerce Notification](src/ebay/commerce/notification/) | Application-level alert configuration under `commerce.notification` |
...
| [Communication](src/tools/categories/communication.ts) | Notification destinations, subscriptions, topics, filters, and public keys |
