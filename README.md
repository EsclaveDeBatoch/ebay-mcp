...
| `sell.inventory` | Seller-defined inventory item groups | "Show the variants in this inventory item group." |
...
| [Sell Inventory](src/ebay/sell/inventory/) | Seller-defined item groups under `sell.inventory` |
