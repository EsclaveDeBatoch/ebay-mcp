...
| `commerce.notification` | Alert configuration, delivery destinations, subscriptions, filters, and validation keys | "Show my notification subscriptions." |
...
| `communication` | Notification topics | "Show filterable notification topics." |
...
| [Commerce Notification](src/ebay/commerce/notification/) | Alert configuration, delivery destinations, subscriptions, filters, and validation keys under `commerce.notification` |
...
| [Communication](src/tools/categories/communication.ts) | Notification topics |
