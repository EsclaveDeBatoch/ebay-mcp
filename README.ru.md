...
| [Account](src/tools/categories/account.ts) | Политики возврата; программы; подписки; налог с продаж |
| [Sell Account](src/ebay/sell/account/) | Определяемые продавцом политики оплаты, доставки, соответствия товаров и обратного приёма |
