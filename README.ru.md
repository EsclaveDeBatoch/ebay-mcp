...
| [Account](src/tools/categories/account.ts) | Устаревший статус платёжной программы; налог с продаж |
| [Sell Account](src/ebay/sell/account/) | Статус продавца, участие в программах, подписки, таблицы тарифов, право на рекламу и бизнес-политики |
