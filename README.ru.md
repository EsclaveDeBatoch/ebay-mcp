...
| [Account](src/tools/categories/account.ts) | Устаревший статус платёжной программы |
| [Sell Account](src/ebay/sell/account/) | Статус продавца, участие в программах, налог с продаж, подписки, таблицы тарифов, право на рекламу и бизнес-политики |
