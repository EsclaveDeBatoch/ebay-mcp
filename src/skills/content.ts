  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '| `types/` | Handwritten migration-era contracts |',
    ...
    },
    {
      heading: 'Conventions',
      body: [
        '- **No `any`** — specific types; prefer narrowing over assertions. `src/generated/ebay/` is generated, so model eBay shapes from the specs.',
