  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '3. `ebay_sell_inventory_create_offer` (SKU, marketplace, price, the policy IDs, location).',
        '4. `ebay_sell_inventory_publish_offer` (offerId) → a live `listingId`. Use `ebay_sell_inventory_bulk_publish_offer` for many at once.',
        '',
