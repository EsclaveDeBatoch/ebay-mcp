  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '1. One-time account setup: `ebay_opt_in_to_program` (business-policy management), then `ebay_sell_account_create_payment_policy`, `ebay_sell_account_create_return_policy`, `ebay_sell_account_create_fulfillment_policy` for reusable policy IDs, and `ebay_create_inventory_location` for a `merchantLocationKey`.',
