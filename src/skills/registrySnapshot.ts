...
const FAMILY_BLURBS: Record<string, string> = {
  ...
  account: 'Payment and return policies, privileges, program opt-in, and sales tax',
  inventory:
  ...
  'sell.account':
    'Seller fulfillment, product-compliance, and take-back policies from Sell Account',
  'sell.analytics':
