...
const BASE_PATH_BINDINGS: readonly BasePathBinding[] = [
  ...
  },
  {
    ...
    constant: 'basePath',
    spec: 'specs/ebay/sell-apps/analytics-and-report/sell_analytics_v1_oas3.json',
  },
  {
    file: 'src/api/communication/feedback.ts',
    constant: 'basePath',
    spec: 'specs/ebay/sell-apps/communication/commerce_feedback_v1_beta_oas3.json',
  },
  {
    file: 'src/api/communication/message.ts',
    constant: 'basePath',
    spec: 'specs/ebay/sell-apps/communication/commerce_message_v1_oas3.json',
  },
  {
  ...
  },
  {
    ...
    constant: 'basePath',
    spec: 'specs/ebay/sell-apps/marketing-and-promotions/sell_recommendation_v1_oas3.json',
  },
  {
  ...
  },
  {
    ...
    constant: 'basePath',
    spec: 'specs/ebay/sell-apps/other-apis/commerce_translation_v1_beta_oas3.json',
  },
  {
