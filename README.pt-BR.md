...
| [Account](src/tools/categories/account.ts) | Status obsoleto do programa de pagamentos |
| [Sell Account](src/ebay/sell/account/) | Status do vendedor, adesão a programas, imposto sobre vendas, assinaturas, tabelas de tarifas, elegibilidade para publicidade e políticas comerciais |
