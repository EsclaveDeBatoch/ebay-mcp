...
| [Account](src/tools/categories/account.ts) | Status do programa de pagamentos; adesão a programas; imposto sobre vendas |
| [Sell Account](src/ebay/sell/account/) | Status do vendedor, assinaturas, tabelas de tarifas, elegibilidade para publicidade e políticas comerciais |
