...
| [Account](src/tools/categories/account.ts) | Políticas de pago y devolución; programas; suscripciones; impuesto sobre ventas |
| [Sell Account](src/ebay/sell/account/) | Políticas de envío, cumplimiento de producto y devolución definidas por el vendedor |
