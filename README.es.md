...
| [Account](src/tools/categories/account.ts) | Estado obsoleto del programa de pagos |
| [Sell Account](src/ebay/sell/account/) | Estado del vendedor, inscripción en programas, impuesto sobre ventas, suscripciones, tablas de tarifas, elegibilidad publicitaria y políticas comerciales |
